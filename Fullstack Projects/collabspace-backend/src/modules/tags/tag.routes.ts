...
import { createTag, deleteTag, listTags, updateTag } from "./tag.controller.js";
import {
  createTagSchema,
...
tagRoutes.use(asyncHandler(requireAuth));
...
tagRoutes.post(
  "/organizations/:organizationId/tags",
  validateRequest({ params: organizationTagParamsSchema, body: createTagSchema }),
  asyncHandler(requireOrganizationRole([OrganizationRole.ADMIN, OrganizationRole.MANAGER])),
