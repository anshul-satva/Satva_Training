...
projectRoutes.post(
  "/organizations/:organizationId/projects",
  validateRequest({ params: organizationProjectParamsSchema, body: createProjectSchema }),
...
projectRoutes.patch(
  ...
  asyncHandler(requireProjectRole([OrganizationRole.ADMIN, OrganizationRole.MANAGER])),
